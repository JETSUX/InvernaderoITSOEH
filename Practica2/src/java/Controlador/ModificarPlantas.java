 ...
 * @author 51737
 */
@WebServlet(name = "ModificarPlantas", urlPatterns = {"/ModificarPlantas"})
public class ModificarPlantas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          /* TODO output your page here. You may use following sample code. */
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Modificar Planta</title>");            
            out.println("</head>");
            out.println("<body>");
                               
            out.println("<h1>Modificar Planta</h1>");
            System.out.println("Planta");
            
            out.println("<form class='form-horizontal' method='post' action='ModificarPlantas1'>");
