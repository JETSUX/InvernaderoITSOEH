 ...
 * @author 51737
 */
@WebServlet(name = "MostrarPlantas", urlPatterns = {"/MostrarPlantas"})
public class MostrarPlantas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          /* TODO output your page here. You may use following sample code. */
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Consultar Planta</title>");            
            out.println("</head>");
            out.println("<body>");
                               
            out.println("<h1>Consulta Planta</h1>");
