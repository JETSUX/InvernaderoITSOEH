 ...
 * @author 51737
 */
@WebServlet(name = "InsertarPlanta", urlPatterns = {"/InsertarPlanta"})
public class InsertarPlanta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>InsertPlanta</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Datos Ingresados Correctamente a la Tabla Planta</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
