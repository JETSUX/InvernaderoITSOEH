 ...
 * @author 51737
 */
@WebServlet(name = "InsertarInsecticida", urlPatterns = {"/InsertarInsecticida"})
public class InsertarInsecticida extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            insecticidaDAO.insert(objInsecticida);
            /* TODO output your page here. You may use following sample code. */
            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>InsertInsecticida</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Datos Ingresados Correctamente a la Tabla Insecticida</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
