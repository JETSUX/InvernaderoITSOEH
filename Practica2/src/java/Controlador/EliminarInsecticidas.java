 ...
 * @author 51737
 */
@WebServlet(name = "EliminarInsecticidas", urlPatterns = {"/EliminarInsecticidas"})
public class EliminarInsecticidas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Eliminar Insecticida</title>");
            out.println("</head>");
            out.println("<body>");

            out.println("<h1>Eliminar Insecticida</h1>");
            System.out.println("Insecticida");

            out.println("<form class='form-horizontal' method='post' action='EliminarInsecticidas1'>");
