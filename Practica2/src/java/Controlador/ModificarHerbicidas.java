 ...
 * @author 51737
 */
@WebServlet(name = "ModificarHerbicidas", urlPatterns = {"/ModificarHerbicidas"})
public class ModificarHerbicidas extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          /* TODO output your page here. You may use following sample code. */
            ...
            System.out.println("Herbicida");
             ...
             out.println("<form class='form-horizontal' method='post' action='ModificarHerbicidas1'>");
